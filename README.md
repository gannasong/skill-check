...
- **RPL-2 (Direction)**: "Use first principles" → AI knows the direction but picks a different path each time.
- **RPL-3 (Reasoning Chain)**: "1. List assumptions → 2. Find evidence for each → 3. Conclude from verified only" → AI is forced to follow the chain. Stable output.
